...
* Fixed: Incorrect theme color preview on older Android versions.
* Added: New "Tropical Paradise" theme for all users.
* Added: New settings options for Plus users.
* Improved: Audio recording performance and stability.
* Updated: "Smart Sleep" is now default label for system alarm.
* Consistently enhance and refine the user interface.

## 0.4.7 (250706.215.m3e)
...
## 0.4.6 (250531.210.rec\_haiten)

* New (Beta): Record custom audio for sleep sounds! Available to all users, more settings for Plus users.
...
* Add a new feature (Plus users only): Now you can add sound files directly from your phone's storage.
